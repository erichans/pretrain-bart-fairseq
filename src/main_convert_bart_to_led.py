...
def create_long_model(
    ...
    tokenizer = BartTokenizerFast(
        vocab_file='/home/TCU/erichm/projetos/pretrain-bart-fairseq/bart/gpt2_bpe/encoder.json', 
        merges_file='/home/TCU/erichm/projetos/pretrain-bart-fairseq/bart/gpt2_bpe/vocab.bpe')
...
def main():
    ...
    create_long_model(
        ...
        tokenizer_name_or_path=f'~/projetos/pretrain-bart-fairseq/bart/gpt2_bpe/',
        max_pos=16384
    )
